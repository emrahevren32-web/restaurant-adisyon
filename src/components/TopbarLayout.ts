...
export const TopbarLayout = ({
  ...
  React.createElement(
    'header',
    { className: 'topbar enterprise-topbar', 'aria-label': 'Workspace üst navigasyon' },
    React.createElement(
      'div',
      { className: 'topbar-leading topbar-context-zone', 'data-topbar-zone': 'left' },
      React.createElement(
        'button',
        {
          type: 'button',
    ...
    React.createElement(
      ...
      React.createElement(
        'div',
        { className: 'topbar-system-actions', 'aria-label': 'Sistem aksiyonları' },
        React.createElement(
          'button',
          {
            type: 'button',
