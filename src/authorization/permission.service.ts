...
export const PERMISSION_CATALOG: PermissionModel[] = [
  ...
  { name: 'restaurant.read', description: 'RestaurantOS operasyon ekranlarini goruntuleme izni.', module: 'restaurantos' },
  { name: 'restaurant.write', description: 'RestaurantOS operasyon verilerini yonetme izni.', module: 'restaurantos' },
