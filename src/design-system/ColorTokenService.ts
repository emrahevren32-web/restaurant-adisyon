...
const createThemeVariableTree = (
  ...
  return {
    theme: {
      ...
      state: {
        ...theme.state,
        active: `color-mix(in srgb, ${accent.soft} 86%, transparent)`,
        selected: `color-mix(in srgb, ${accent.soft} 92%, transparent)`,
        focusRing: `0 0 0 3px color-mix(in srgb, ${accent.base} 24%, transparent)`
      },
      shadow: theme.shadow,
      blur: theme.blur,
      radius: theme.radius,
...
const createCompatibilityThemeVariables = () => [
  '--bg:var(--theme-app-canvas);',
  '--app-bg:var(--theme-app-bg);',
  '--canvas:var(--theme-app-canvas);',
  '--workspace:color-mix(in srgb, var(--theme-app-bg) 72%, var(--theme-surface-1));',
  '--surface:var(--theme-surface-1);',
  '--surface-canvas:var(--theme-surface-0);',
  '--surface-muted:var(--theme-surface-2);',
  '--surface-subtle:var(--theme-surface-3);',
  '--surface-raised:var(--theme-card-raised);',
  '--surface-floating:var(--theme-elevation-3-background);',
  '--surface-overlay:var(--theme-glass-modal-background);',
  ...
  '--accent-contrast:var(--theme-semantic-primary-contrast);',
  '--focus-color:var(--theme-border-focus);',
  '--focus-ring:var(--theme-state-focus-ring);',
  '--selection:var(--theme-state-selected);',
  '--selection-soft:var(--theme-semantic-primary-soft);',
  ...
  '--color-app-canvas:var(--theme-app-canvas);',
  '--color-background-subtle:var(--theme-app-muted);',
  '--color-surface:var(--theme-surface-1);',
  '--color-surface-canvas:var(--theme-surface-0);',
  ...
  '--color-surface-floating:var(--theme-elevation-3-background);',
  '--color-surface-overlay:var(--theme-glass-modal-background);',
  ...
  '--color-selection-background:var(--theme-state-selected);',
  ...
  '--color-focus:var(--theme-border-focus);',
