...
<head>
  ...
  <style>
    * { box-sizing:border-box; }
    ...
    .sheet { max-width:960px; margin:0 auto; padding:${PRINT_SPACING_VALUES.space24}; border:1px solid #d1d5db; border-radius:${PRINT_RADIUS_VALUES.card}; background:#fff; }
    ...
    .history { display:grid; gap:${PRINT_SPACING_VALUES.space8}; }
    .history div { border:1px solid #e5e7eb; border-radius:${PRINT_RADIUS_VALUES.box}; padding:${PRINT_SPACING_VALUES.space8}; background:#f9fafb; }
    @media print {
