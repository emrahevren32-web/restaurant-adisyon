...
<head>
  ...
  <style>
    * { box-sizing:border-box; }
    ...
    .sheet { max-width:1220px; margin:0 auto; padding:${PRINT_SPACING_VALUES.space24}; border:1px solid #d1d5db; border-radius:${PRINT_RADIUS_VALUES.card}; background:#fff; }
