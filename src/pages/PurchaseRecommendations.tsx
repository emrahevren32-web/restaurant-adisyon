...
<head>
  ...
  <style>
    * { box-sizing:border-box; }
    ...
    .sheet { max-width:1180px; margin:0 auto; padding:${PRINT_SPACING_VALUES.space20}; border:1px solid ${PRINT_THEME_COLORS.border}; border-radius:8px; background:${PRINT_THEME_COLORS.background}; }
