...
<head>
  ...
  <style>
    * { box-sizing:border-box; }
    ...
    .sheet { max-width:1320px; margin:0 auto; padding:${PRINT_SPACING_VALUES.space20}; border:1px solid ${PRINT_THEME_COLORS.border}; border-radius:${PRINT_RADIUS_VALUES.card}; background:${PRINT_THEME_COLORS.background}; }
